...
const ABOUT_TEXT =
  "I'm Ever Jay Salango, a Full Stack Developer from the Davao del Norte with a passion for building modern, scalable web applications. I focus on delivering clean code, intuitive user experiences, and impactful digital solutions — from reservation systems and GIS tools to management platforms and brand-focused web apps. I am passionate about turning ideas into digital experiences that make a meaningful impact.";  
export default function AboutSection() {
  return (
    ...
    >
      {/* Decorative corners — kept from original design */}
